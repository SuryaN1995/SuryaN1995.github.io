...
const VIEW_BOX = "0 0 1061 742.85506";

export default class BlogsImg extends Component {
  render() {
    const theme = this.props.theme;
    return (
      <div className="art art--blogs">
        <svg className="art__layer" viewBox={VIEW_BOX}>
          <title>task</title>
          <g>
            <path
          ...
          <rect
            ...
            width="428.42594"
            height="209.61613"
            fill={theme.imageScreen}
          />
        </svg>
        <svg className="art__layer art__card" viewBox={VIEW_BOX}>
          <g>
            <rect
              x="256.50394"
              y="241.79404"
        ...
        <svg className="art__layer art__person" viewBox={VIEW_BOX}>
          <g>
            <path
